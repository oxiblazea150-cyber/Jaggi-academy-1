        ...
        <>
            ...
            >
                <div className="max-w-7xl mx-auto px-5 sm:px-8 h-[72px] flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-6 text-sm">
                        ...
                        <a href="/admin/dashboard" className="sweep-link font-medium flex items-center gap-1.5" style={{ color: 'var(--cobalt-light)' }}>
            ...
            >
                ...
                >
                    ...
                    {/* Drawer CTA */}
                    <div className="p-6 border-t flex flex-col gap-3" style={{ borderColor: 'var(--divider)' }}>
                        ...
                        <a href="/admin/dashboard" onClick={close}
                            className="flex items-center justify-center gap-2 font-semibold rounded-xl py-3 text-sm transition-colors border"
                            style={{ borderColor: 'var(--divider)', color: 'var(--cobalt)', background: 'var(--paper)' }}>
